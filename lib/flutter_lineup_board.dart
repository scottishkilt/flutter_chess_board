...
class _LineupBoardState extends State<LineupBoard> {
  ...
  void initState() {
    ...
    super.initState();
    if (widget.lineupBoardController != null) {
      widget.lineupBoardController.game = game;
      widget.lineupBoardController.refreshBoard = refreshBoard;
    }
...
class LineupSquare extends StatefulWidget {
  ...
  LineupSquare(this.squareName, this.game, this.size, this.onMove,
      this.refreshBoard, this.enableUserMoves);

  @override
  _LineupSquareState createState() => _LineupSquareState();
}

class _LineupSquareState extends State<LineupSquare> {
  @override
  Widget build(BuildContext context) {
    return Expanded(
      flex: 1,
